...
<body class="h-screen flex justify-center items-center">
    <div class="flex w-full h-full relative">
        ...
        <div class="flex-1 relative bg-cover bg-center" style="background-image: url('<?= base_url() ?>images/sanchaya1.png');">
        ...
        <div class="flex-1 relative bg-cover bg-center" style="background-image: url('<?= base_url() ?>images/wijaya1.png');">
            <div class="absolute inset-0 flex flex-col justify-center items-center">
                <a href ="/thewijaya">
